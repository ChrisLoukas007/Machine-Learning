...
In my GitHub repository, I have uploaded code examples for each of these regression techniques, which can be easily applied to a dataset by changing the name of the dataset. These codes include steps for data preprocessing, creating and fitting the model, and evaluating the model's performance.
